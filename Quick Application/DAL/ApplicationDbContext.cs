...
namespace DAL
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Discipline>().Property(c => c.Name).IsRequired().HasMaxLength(100);
            builder.Entity<Discipline>().HasIndex(c => c.Name);
            builder.Entity<Discipline>().ToTable($"App{nameof(this.Disciplines)}");
        }
